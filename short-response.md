...
1. First, I would make sure the server actually has a PATCH route defined for /api/bookmarks/:id. If the route doesn’t exist or is typed incorrectly (e.g. /api/bookmark/:id without the “s”), Express won’t match it and will return a 404.
